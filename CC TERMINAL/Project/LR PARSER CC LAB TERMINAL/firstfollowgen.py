...
def first_set(G, T, Nt):
    ...
    while True:
        ...
        if flag:
            ...
            print('---------------')
        for NonT in Nt:
            firstA[NonT] = [i for i in tempA[NonT]]
    return firstA
            ...
            for i in range(len(rhs)):
                ...
                if Ai in Nt:
                    ...
                    if w in T:
                        add(tempA[Ai], w)
                    if w in Nt:
                        for k in first_set_list[w]:
                            add(tempA[Ai], k) if k != '' else add(tempA[Ai], '$')
            flag = True
        for NonT in Nt:
            flag = flag and (tempA[NonT] == followA[NonT])
        if flag:
            break
        else:
            print(tempA)
            ...
            print('//////////////')
        for NonT in Nt:
            followA[NonT] = [i for i in tempA[NonT]]
    return followA
